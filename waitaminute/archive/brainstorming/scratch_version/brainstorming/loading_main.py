...
loading_label = tk.Label(loading, text="Loading Nova System...", fg="cyan", bg="black", font=("Courier", 12))
loading_label.pack(pady=20)

loading.update()

time.sleep(2)  # Let the loading screen stay for 2 seconds

loading.destroy()  # Destroy the loading screen
